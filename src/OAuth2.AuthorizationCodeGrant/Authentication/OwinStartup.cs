...
[assembly: OwinStartup(typeof(OAuth2.AuthorizationCodeGrant.Authentication.OwinStartup))]
namespace OAuth2.AuthorizationCodeGrant.Authentication
{
    public class OwinStartup
    {
        ...
        private void ConfigureOAuth(IAppBuilder appBuilder)
        {
            OAuthAuthorizationServerOptions serverOptions = new OAuthAuthorizationServerOptions
            {
                ...
                AuthorizationCodeProvider = new Providers.SimpleAuthorizationCodeProvider(),
