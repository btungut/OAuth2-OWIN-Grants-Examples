...
namespace OAuth2.ClientCredentialsGrant.Authentication.Providers
{
    public class SimpleOAuthAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override Task GrantClientCredentials(OAuthGrantClientCredentialsContext context)
        {
            ...
            //Client id kontrolü yapılıyor. Extra olarak request header'dan bilgiler de alınabilir. (Twitter gibi)
